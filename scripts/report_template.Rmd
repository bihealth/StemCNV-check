...
output:
  ...
  pdf_document:
    default
params:
  base_path: '/home/vonkunic_c/Misc-Projects/StemCNV-analysis/test_new'
  sample_id: 'HG001'
  sampletable: '/home/vonkunic_c/Misc-Projects/StemCNV-analysis/test_new/sample_table.txt'
  report_name: 'StemCNV-check-report'
  out_format: 'html'
  configfile: '/home/vonkunic_c/Misc-Projects/StemCNV-analysis/test_new/full_testconfig.yaml'
  workdir: '/home/vonkunic_c/Misc-Projects/StemCNV-analysis/test_new/data/HG001'
  version: 'unversioned'
---
...
CNV_table_output <- function(tb, plotsection, caption = NULL) {
  ...
  if (params$out_format == 'html') {
    ...
    column_help_text <- c(
            ...
            'High impact hits overlapping with this CNV call',
            'Highlight hits overlapping with this CNV call',
            #TODO: add a doi here, once available
    ...
    dt <- datatable(tb %>% rename_with(format_column_names),
            ...
            options = list(
              ...
              columnDefs = list(
                ...
                list(targets = c(0:2,9:10,17:(ncol(tb)-1)), visible = FALSE)
              )
            ),
            callback = JS(
...
metric.colors <- list(
    ...
    mutate(metrics[[4]],
                 loss_gain_log2ratio = ifelse(loss_gain_log2ratio == 'div/0', 'white',
                    apply_greq_th(abs(loss_gain_log2ratio), ratio_CNV_warnings, 'loss_gain_log2ratio')),
...
if (params$out_format == 'html') {
  ...
  summary_row_help <- c(
          ...
          "Computed Gender" = 'The Illumina computed gender (sex) based on X and Y chromosome probes.\\nMismtaches with annotated sex can indicate  annotation mistakes, sample swaps, or severe quality issues.',
