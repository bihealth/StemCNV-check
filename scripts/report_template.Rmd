...
format_hotspots_to_badge <- function(hotspot_vec, CNVtype_vec, list = 'high_impact') {
          ...
          mutate(source = str_replace(source, '\\n', '&#013;'),
                 out_str = ifelse(
                   ...
                   paste0(str_glue('<span class="badge badge-{shorthand}" title="'),
                          str_glue('{list} list name: {list_name}&#013;'), #\\n
...
metric.colors <- list(
    ...
    mutate(metrics[[3]],
                 SNP_distance_to_reference = ifelse(SNP_distance_to_reference == '-', 'white',
                                              apply_greq_th(SNP_distance_to_reference, SNP_distance_to_ref_warning,
