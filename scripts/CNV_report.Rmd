...
params:
  ...
  sample_id: 'BIHi005-A'  #'GSM2538923_9371579017'
  sampletable: 'sample_table_example.txt' #'sample_table.txt'
  report_name: 'CNV-report'
  out_format: 'html'
  configfile: 'test/test_config.yaml'
  workdir: '/home/vonkunic_c/Misc-Projects/CNV-pipeline/test/data/BIHi005-A'
---
...
simple_table_output <- function(tb, caption=NULL) {
  if (params$out_format == 'html') {
    #TODO: might want to use kable here as well?
...
green_col = ifelse(params$out_format == 'html', '#92D050', 'green')
