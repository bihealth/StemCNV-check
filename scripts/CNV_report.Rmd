...
if (length(regions)>0) {
	for (region in regions) {
		...
		cat(paste0('### Region:', Chr, ': ', Start, ' - ', End, ' (', round(Size/size_order, 1), size_str ,')\n\n'))
