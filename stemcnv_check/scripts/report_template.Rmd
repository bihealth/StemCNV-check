...
paste(
    ...
    'are annotated at least as protein changing. The "SNV label" further categorizes the SNVs into critical,',
    'unreliable critical (due to missing reference or bad quality calls), protein changing, and reference genotype.',    
    'The hidden "Critical reason" column has further details on why a SNV is considered critical. These are also',
    'highlighted in the "ROI Hits", "Gene Name" (curated hotspots for stem cells) and "Annotation" (specific effect of',
    'the SNP on the protein) columns.\n\n'
