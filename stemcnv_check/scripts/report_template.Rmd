...
crit_excl_filters <- ifelse(
    is.null(config$evaluation_settings$CNV_call_labels$filters.exclude.critical),
    '<none>',
    config$evaluation_settings$CNV_call_labels$filters.exclude.critical %>% paste(collapse = ', ')
)
repo_excl_filters <- ifelse(
    is.null(config$evaluation_settings$CNV_call_labels$filters.exclude.reportable),
    '<none>',
    config$evaluation_settings$CNV_call_labels$filters.exclude.reportable %>% paste(collapse = ', ')
)
...
paste(
    ...
    ' - Critical Check_Score:', config$evaluation_settings$CNV_call_labels$check_score.critical, '\n\n',
    ' - Critical exclusion Filters:', crit_excl_filters, '\n\n',
    ' - Reportable Check_Score:', config$evaluation_settings$CNV_call_labels$check_score.reportable, '\n\n',
...
paste(
    ...
    ' - "Annotation" and "Impact", specific effect of the SNP on the gene based on mehari\n\n',
...
snv_annotation_tb <- tibble(
    ...
    hotspot = c(
        config$settings$SNV_analysis$critical_annotations$Impact,
        config$settings$SNV_analysis$critical_annotations$Annotation
    ),
