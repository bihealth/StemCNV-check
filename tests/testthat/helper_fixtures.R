...
minimal_hotspots <- tibble::tibble(
    ...
    description = c('Source: dummy', 'Something: Dummy{1}', 'general\\nSource: dummy', 'Source: dummy{1}\\nSomething: else{2}',
                    'Source: dummy', 'Sources: dummy{1}, dummy{2}'),
    description_doi = c(NA_character_, 'doi', NA_character_, 'doi, doi2', NA_character_, 'doi, doi2'),
    description_htmllinks = c(
        'Source: dummy', 
        'Something: <a href="https://doi.org/doi" target="_blank" rel="noopener noreferrer">Dummy</a>',
        'general&#013;Source: dummy',
        'Source: <a href="https://doi.org/doi" target="_blank" rel="noopener noreferrer">dummy</a>&#013;Something: <a href="https://doi.org/doi2" target="_blank" rel="noopener noreferrer">else</a>',
        'Source: dummy', 
