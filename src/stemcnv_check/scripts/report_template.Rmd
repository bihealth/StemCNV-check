...
paste(
    ...
    ' - "HGVS.p", specific mutation in the protein, which may overlap with a known stemcell hotspot (see also next tab)\n\n',
    ' - "Gene Name", hits in genes that have known hotspots for stem cells, see also the next "SNV hotspot coverage" tab\n\n',
